...
public:
    ...
    */
    ...
    /**
      @copydoc
      StorageBackend::loadUnreadInvitationIncidences()
    */
    int loadUnreadInvitationIncidences();

    /**
      @copydoc
      StorageBackend::loadInvitationIncidences()
    */
...
protected:
    ...
    bool modifyNotebook(const Notebook::Ptr &nb, StorageBackend::DBOperation dbop, bool signal = true);
