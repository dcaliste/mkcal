...
public:
    ...
    bool mIsUnreadIncidencesLoaded = false;
...
bool StorageBackend::isUnreadIncidencesLoaded()
{
    return d->mIsUnreadIncidencesLoaded;
}

void StorageBackend::setIsUnreadIncidencesLoaded(bool loaded)
{
    d->mIsUnreadIncidencesLoaded = loaded;
}

bool StorageBackend::isInvitationIncidencesLoaded()
{
    return d->mIsInvitationIncidencesLoaded;
}

void StorageBackend::setIsInvitationIncidencesLoaded(bool loaded)
{
...
bool StorageBackend::addNotebook(const Notebook::Ptr &nb)
{
    if (!nb) {
        return false;
    }
...
bool StorageBackend::updateNotebook(const Notebook::Ptr &nb)
{
    if (!nb) {
        return false;
    }
