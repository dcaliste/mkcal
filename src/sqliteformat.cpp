...
public:
    ...
    bool modifyCalendarProperties(const Notebook &notebook, StorageBackend::DBOperation dbop);
                                   ...
                                   StorageBackend::DBOperation dbop)
{
    ...
    sqlite3_int64  secs;
    const char *operation = (dbop == StorageBackend::DBInsert) ? "inserting" :
                            (dbop == StorageBackend::DBUpdate) ? "updating" : "deleting";
...
Notebook* SqliteFormat::selectCalendars(sqlite3_stmt *stmt)
{
    int rv = 0;
...
Incidence* SqliteFormat::selectComponents(sqlite3_stmt *stmt1, QString &notebook)
{
    int rv = 0;
    int index = 0;
    Incidence *incidence = nullptr;
    QString type;
    QString timezone;
    int rowid;
